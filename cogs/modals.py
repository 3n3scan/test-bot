...
class ModalCog(commands.Cog):
    ...
    async def button_modal(self, ctx):
        await ctx.respond("Erstelle mit dem Button mithilfe der Modal funktion ein Embed!", view=TutorialView())
...
class TutorialView(discord.ui.View):
    @discord.ui.button(label="Jetzt ein Embed erstellen!", style=discord.ButtonStyle.green)
